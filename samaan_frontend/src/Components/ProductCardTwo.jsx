...
const ProductCardTwo = ({cartquantity,productId,imgSrc,name,price,weight,category}) => {
        ...
        <div class="price">
          ...
          <div className='bg-[rgb(247, 255, 249)] w-[1.4rem] h-[1.4rem] text-center font-[900] text-green-800  rounded-full cursor-pointer flex justify-center items-center border border-green-600' onClick={()=>{
            ...
            changequantaty(1)
                ...
                <button  onClick={()=>{ if (authTokens){ setquantity(quantity+1);changequantaty(1)}else{
                  navigate("/signupuser")
                }}  } >ADD</button>}
            </div>
        </div>
